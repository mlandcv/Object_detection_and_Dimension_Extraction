 ...
 #               (int(tltrX - 15), int(tltrY - 10)), cv2.FONT_HERSHEY_SIMPLEX,
  #              0.65, (255, 255, 255), 2)
   #         cv2.putText(orig, "{:.1f}in".format(dimB),
    ...
    df = pd.DataFrame.from_dict({'Extracted_Diameter':DIMB,'Extracted_Overcross':DIMA})
    df.to_excel('C:\\Users\\user\\Desktop\\codetest\\size-of-objects\\output.xlsx', header=True, index=False)
