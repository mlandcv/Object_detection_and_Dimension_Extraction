...
def save_image(image, image_name, boxes, masks, class_ids, scores, class_names, filter_classs_names=None,
    ...
    if save_dir is None:
        save_dir = os.path.join(os.getcwd(), "Mask_RCNN\output")
...
def display_instances(image, boxes, masks, class_ids, class_names,
    ...
    #plt.savefig('C:\\Users\\user\\Desktop\\codetest\\Mask_RCNN\\detection\\output_{}.jpg'.format(time.strftime("%Y%m%d-%H%M%S")))#to save file in local directory for n no of input images with date and time 
